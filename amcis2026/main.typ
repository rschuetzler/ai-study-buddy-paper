...
We will recruit N=100 students who are (1) 18 years or older, (2) fluent in English, and (3) enrolled at Brigham Young University. Twenty-five participants will be assigned to each of the four conditions: AI on participant's laptop, AI on Reachy Mini robot, AI on researcher-provided laptop, and control (no AI). 

== Study Procedure

Upon arrival at the research site, participants will be briefed on the overall study procedure and sign the written informed consent form to participate in the study. Then, with a script, they will be asked to complete a set of pre-study questionnaires to collect information about their demographic and usual self-study behaviors and habits.
...
For all three AI conditions, participants will begin by verbally stating their SMART goal (Specific, Measurable, Achievable, Relevant, Time-bound) to the AI system. The AI will acknowledge the goal and set a timer for the thirty-minute study session. During the study session, the AI will not provide any interventions, reminders, or support. At the conclusion of the thirty minutes, the AI will notify the participant that time has elapsed. This minimal-intervention approach differs from prior work in that it isolates the effect of AI presence and embodiment rather than active motivational support.
