...
#show: amcis.with(
  ...
  abstract: abstract,
  keywords: ([human-robot interaction], [body doubling], [social presence]),
...
#figure(image("assets/reachy.jpg", height: 23%),
...
After the self-study session, participants will complete a post-study questionnaire to measure perceived stress and concentration on academic workload, perceived productivity and concentration level during the self-study session, effectiveness of the AI companion (where applicable), and the acceptance of assistive robot scale developed by #cite(<heerink2008Influence>, form: "prose"), which measures the effectiveness of intervention, the system's perceived ease of use, perceived usefulness, perceived enjoyment, trust in the system, and overall satisfaction. For the control condition, participants will complete adapted versions of these scales that assess their self-study experience without reference to an AI system.
...
= Conclusion
Body doubling is a valuable technique used by self-motivated individuals to improve their work efficacy. In this paper we propose an experiment to study the effectiveness of AI interventions as body doubling companions. Our study will compare laptop-based chatbots and robot-embodied chatbots to determine the value of physical presence in body doubling, and the ability of an AI tool to improve productivity on knowledge tasks.
